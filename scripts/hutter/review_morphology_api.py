...
def build_messages(
    ...
    system = (
        ...
        "surrounding alignment as evidence. Select a candidate only when the supplied Hebrew "
        "surface and morphology clearly support it; otherwise use choice null. Treat deterministic "
        "candidates as evidence, not truth. Return JSON only as an array with one object per item "
